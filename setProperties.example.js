// setProperties.example.gs
// Note this file is used to create the setProperties.gs file that is not kept in git repo
// Note the setProperties.gs file contains constants that are particular to the application
